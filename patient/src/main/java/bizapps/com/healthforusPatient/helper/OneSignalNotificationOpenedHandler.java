package bizapps.com.healthforusPatient.helper;
...
public class OneSignalNotificationOpenedHandler implements OneSignal.NotificationOpenedHandler {
  ...
  @Override public void notificationOpened(OSNotificationOpenResult result) {
    ...
    System.out.println(TAG+" shit : notificationOpened() payload = " + (data != null ? data.toString() : null));
    if (data != null) {
    ...
    if (actionType == OSNotificationAction.ActionType.ActionTaken) {
      System.out.println(TAG+" shit : Button pressed with id: " + result.action.actionID);
    }
