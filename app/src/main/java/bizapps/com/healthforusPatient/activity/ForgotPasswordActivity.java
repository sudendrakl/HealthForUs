...
import bizapps.com.healthforusPatient.utills.URLConstants;
...
//				URLConstants.getPatientForgotPasswordUrl,
				"http://medico4us.in/patientUpdatePassword.php",
				new JSONObject(jsonParams), new Response.Listener<JSONObject>() {
			@Override
			public void onResponse(JSONObject response) {
				try{
					Log.e("UpdateForgotPWD",""+response);
					if(response != null){
...
//							enableNewPasswordRequest();
	...
	private void sendForgotServerRequest() {
		...
		JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST,
//				URLConstants.getPatientForgotPasswordUrl,
				"http://medico4us.in/patientForgotPassword.php",
				new JSONObject(jsonParams), new Response.Listener<JSONObject>() {
			@Override
			public void onResponse(JSONObject response) {
				try{
